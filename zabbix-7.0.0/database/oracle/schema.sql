...
CREATE TABLE ugset (
	ugsetid                  number(20)                                NOT NULL,
	hash                     nvarchar2(64)   DEFAULT ''                ,
	PRIMARY KEY (ugsetid)
);
...
CREATE TABLE hosts (
	...
	proxy_groupid            number(20)                                NULL,
	monitored_by             number(10)      DEFAULT '0'               NOT NULL,
	PRIMARY KEY (hostid)
);
...
CREATE TABLE group_discovery (
	groupdiscoveryid         number(20)                                NOT NULL,
	groupid                  number(20)                                NOT NULL,
...
CREATE TABLE drules (
	...
	status                   number(10)      DEFAULT '0'               NOT NULL,
	concurrency_max          number(10)      DEFAULT '0'               NOT NULL,
...
CREATE TABLE dchecks (
	...
	allow_redirect           number(10)      DEFAULT '0'               NOT NULL,
...
CREATE TABLE httptest (
	...
	http_user                nvarchar2(255)  DEFAULT ''                ,
	http_password            nvarchar2(255)  DEFAULT ''                ,
	hostid                   number(20)                                NOT NULL,
	templateid               number(20)                                NULL,
...
CREATE TABLE items (
	...
	history                  nvarchar2(255)  DEFAULT '31d'             ,
	...
	discover                 number(10)      DEFAULT '0'               NOT NULL,
	uuid                     nvarchar2(32)   DEFAULT ''                ,
	lifetime_type            number(10)      DEFAULT '0'               NOT NULL,
	enabled_lifetime_type    number(10)      DEFAULT '2'               NOT NULL,
	enabled_lifetime         nvarchar2(255)  DEFAULT '0'               ,
	PRIMARY KEY (itemid)
);
...
CREATE TABLE media_type (
	...
	message_format           number(10)      DEFAULT '1'               NOT NULL,
...
CREATE TABLE usrgrp (
	...
	userdirectoryid          number(20)      DEFAULT NULL              NULL,
	mfa_status               number(10)      DEFAULT '0'               NOT NULL,
	mfaid                    number(20)                                NULL,
...
CREATE TABLE scripts (
	...
	manualinput              number(10)      DEFAULT '0'               NOT NULL,
	manualinput_prompt       nvarchar2(255)  DEFAULT ''                ,
	manualinput_validator    nvarchar2(2048) DEFAULT ''                ,
	manualinput_validator_type number(10)      DEFAULT '0'               NOT NULL,
	manualinput_default_value nvarchar2(255)  DEFAULT ''                ,
...
CREATE TABLE config (
	...
	hk_audit                 nvarchar2(32)   DEFAULT '31d'             ,
	...
	hk_history               nvarchar2(32)   DEFAULT '31d'             ,
	...
	geomaps_tile_url         nvarchar2(2048) DEFAULT ''                ,
	...
	timeout_zabbix_agent     nvarchar2(255)  DEFAULT '3s'              ,
	timeout_simple_check     nvarchar2(255)  DEFAULT '3s'              ,
	timeout_snmp_agent       nvarchar2(255)  DEFAULT '3s'              ,
	timeout_external_check   nvarchar2(255)  DEFAULT '3s'              ,
	timeout_db_monitor       nvarchar2(255)  DEFAULT '3s'              ,
	timeout_http_agent       nvarchar2(255)  DEFAULT '3s'              ,
	timeout_ssh_agent        nvarchar2(255)  DEFAULT '3s'              ,
	timeout_telnet_agent     nvarchar2(255)  DEFAULT '3s'              ,
	timeout_script           nvarchar2(255)  DEFAULT '3s'              ,
	auditlog_mode            number(10)      DEFAULT '1'               NOT NULL,
	mfa_status               number(10)      DEFAULT '0'               NOT NULL,
	mfaid                    number(20)                                NULL,
	software_update_checkid  nvarchar2(32)   DEFAULT ''                ,
	software_update_check_data nvarchar2(2048) DEFAULT ''                ,
	timeout_browser          nvarchar2(255)  DEFAULT '60s'             ,
...
CREATE TABLE media (
	...
	userdirectory_mediaid    number(20)      DEFAULT NULL              NULL,
	PRIMARY KEY (mediaid)
);
...
CREATE TABLE host_inventory (
	...
	url_a                    nvarchar2(2048) DEFAULT ''                ,
	url_b                    nvarchar2(2048) DEFAULT ''                ,
	url_c                    nvarchar2(2048) DEFAULT ''                ,
...
CREATE TABLE item_discovery (
	...
	ts_delete                number(10)      DEFAULT '0'               NOT NULL,
	status                   number(10)      DEFAULT '0'               NOT NULL,
	disable_source           number(10)      DEFAULT '0'               NOT NULL,
	ts_disable               number(10)      DEFAULT '0'               NOT NULL,
...
CREATE TABLE item_rtname (
	itemid                   number(20)                                NOT NULL,
	name_resolved            nvarchar2(2048) DEFAULT ''                ,
	name_resolved_upper      nvarchar2(2048) DEFAULT ''                ,
	PRIMARY KEY (itemid)
);
...
CREATE TABLE widget_field (
	...
	name                     nvarchar2(255)  DEFAULT ''                ,
	value_int                number(10)      DEFAULT '0'               NOT NULL,
	value_str                nvarchar2(2048) DEFAULT ''                ,
...
CREATE TABLE connector (
	...
	status                   number(10)      DEFAULT '1'               NOT NULL,
	tags_evaltype            number(10)      DEFAULT '0'               NOT NULL,
	item_value_type          number(10)      DEFAULT '31'              NOT NULL,
	attempt_interval         nvarchar2(32)   DEFAULT '5s'              ,
...
CREATE TABLE proxy (
	proxyid                  number(20)                                NOT NULL,
	name                     nvarchar2(128)  DEFAULT ''                ,
	operating_mode           number(10)      DEFAULT '0'               NOT NULL,
	description              nvarchar2(2048) DEFAULT ''                ,
	tls_connect              number(10)      DEFAULT '1'               NOT NULL,
	tls_accept               number(10)      DEFAULT '1'               NOT NULL,
	tls_issuer               nvarchar2(1024) DEFAULT ''                ,
	...
	tls_psk_identity         nvarchar2(128)  DEFAULT ''                ,
	tls_psk                  nvarchar2(512)  DEFAULT ''                ,
	allowed_addresses        nvarchar2(255)  DEFAULT ''                ,
	address                  nvarchar2(255)  DEFAULT '127.0.0.1'       ,
	port                     nvarchar2(64)   DEFAULT '10051'           ,
	custom_timeouts          number(10)      DEFAULT '0'               NOT NULL,
	timeout_zabbix_agent     nvarchar2(255)  DEFAULT ''                ,
	timeout_simple_check     nvarchar2(255)  DEFAULT ''                ,
	timeout_snmp_agent       nvarchar2(255)  DEFAULT ''                ,
	timeout_external_check   nvarchar2(255)  DEFAULT ''                ,
	timeout_db_monitor       nvarchar2(255)  DEFAULT ''                ,
	timeout_http_agent       nvarchar2(255)  DEFAULT ''                ,
	timeout_ssh_agent        nvarchar2(255)  DEFAULT ''                ,
	timeout_telnet_agent     nvarchar2(255)  DEFAULT ''                ,
	timeout_script           nvarchar2(255)  DEFAULT ''                ,
	local_address            nvarchar2(255)  DEFAULT ''                ,
	local_port               nvarchar2(64)   DEFAULT '10051'           ,
	proxy_groupid            number(20)                                NULL,
	timeout_browser          nvarchar2(255)  DEFAULT ''                ,
	PRIMARY KEY (proxyid)
);
...
CREATE TABLE proxy_group (
	proxy_groupid            number(20)                                NOT NULL,
	name                     nvarchar2(255)  DEFAULT ''                ,
	description              nvarchar2(2048) DEFAULT ''                ,
	failover_delay           nvarchar2(255)  DEFAULT '1m'              ,
	min_online               nvarchar2(255)  DEFAULT '1'               ,
...
CREATE TABLE host_proxy (
	hostproxyid              number(20)                                NOT NULL,
	hostid                   number(20)                                NULL,
	host                     nvarchar2(128)  DEFAULT ''                ,
	proxyid                  number(20)                                NULL,
...
CREATE TABLE mfa (
	mfaid                    number(20)                                NOT NULL,
	type                     number(10)      DEFAULT '0'               NOT NULL,
	name                     nvarchar2(128)  DEFAULT ''                ,
	hash_function            number(10)      DEFAULT '1'               NULL,
	code_length              number(10)      DEFAULT '6'               NULL,
	api_hostname             nvarchar2(1024) DEFAULT ''                ,
	clientid                 nvarchar2(32)   DEFAULT ''                ,
	client_secret            nvarchar2(64)   DEFAULT ''                ,
	PRIMARY KEY (mfaid)
);
CREATE UNIQUE INDEX mfa_1 ON mfa (name);
CREATE TABLE mfa_totp_secret (
	mfa_totp_secretid        number(20)                                NOT NULL,
	mfaid                    number(20)                                NOT NULL,
	userid                   number(20)                                NOT NULL,
	totp_secret              nvarchar2(32)   DEFAULT ''                ,
	status                   number(10)      DEFAULT '0'               NOT NULL,
	used_codes               nvarchar2(32)   DEFAULT ''                ,
...
INSERT INTO dbversion VALUES ('1','7000000','7000000');
...
begin
insert into changelog (object,objectid,operation,clock)
values (19,:new.proxyid,1,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (19,:old.proxyid,2,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (19,:old.proxyid,3,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (20,:new.proxy_groupid,1,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (20,:old.proxy_groupid,2,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (20,:old.proxy_groupid,3,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (21,:new.hostproxyid,1,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (21,:old.hostproxyid,2,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
...
begin
insert into changelog (object,objectid,operation,clock)
values (21,:old.hostproxyid,3,(cast(sys_extract_utc(systimestamp) as date)-date'1970-01-01')*86400);
end;
/
